var hooysasat = ['Возможно', 'Я не уверен', 'Скорее всего - да', 'Скорее всего - нет', 'Это нереально', 'Да, конечно',
               ...
               'Вполне нереально, 'Из-за твоего вопроса - я сломался (нет)', 'У тебя плохие вопросы', 
               'Не отвечу на такой вопрос', 'Ты уверен, что хочешь задать этот вопрос?']
